...
export class AuthService {
  ...
  public login(): Observable<any> {
    let keyInstance = this.keycloakService.getKeycloakInstance()
    let token = this.keycloakService.getKeycloakInstance().token
    console.log("this.keycloakService.getKeycloakInstance();-->" + JSON.stringify(this.keycloakService.getKeycloakInstance()))
    console.log("this.keycloakService.getKeycloakInstance().token;-->" + this.keycloakService.getKeycloakInstance().token)
